...
// Mudar Aqui o e-mail
$email_envio = 'contato@engenhariaasn.com'; // E-mail do site (ex: contato@seusite.com)
$email_pass = 'kbc06740'; // Senha do e-mail

$site_name = 'Engenharia asn'; // Nome do Site
$site_url = 'www.engenhairaasn.com'; // URL do Site

$host_smtp = 'mail.engenhairaasn.com'; // HOST SMTP Ex: smtp.domain.com.br
